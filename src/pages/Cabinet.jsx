...
function Cabinet() {
    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            setSuccess('Пароль успешно изменен. Возвращаемся на главную...');
            ...
            if (err.response?.data?.errors) {
                ...
                setError(err.response?.data?.msg || 'Не удалось изменить пароль. Пожалуйста попробуйте снова.');
            }
        } finally {
            setLoading(false);
        }
    ...
    return (
        <Container maxWidth="sm" sx={{ mt: 4 }}>
            <Paper elevation={3} sx={{ p: 4, borderRadius: 2 }}>
                ...
                <TextField readOnly label="Email" variant="outlined" fullWidth margin="normal" value={localStorage.getItem('Email')} />
