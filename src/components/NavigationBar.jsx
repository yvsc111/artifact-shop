      ...
      <Toolbar>
        {isMobile ? (
          ...
          <>
            ...
            {isLoggedIn ? (
              <Button color="inherit" component={Link} to="/cabinet" sx={{ fontSize: '1rem', marginLeft: '0.5rem' }}>
                Личный кабинет
              </Button>
            ) : (<>
              <Button color="inherit" component={Link} to="/register" sx={{ fontSize: '1rem', marginLeft: '0.5rem', marginRight: '0.5rem' }}>
                Регистрация
              </Button>
            </>)}
            {/* Cart Icon */}
